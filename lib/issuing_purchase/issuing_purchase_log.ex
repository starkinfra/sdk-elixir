defmodule StarkInfra.IssuingPurchase.Log do
  ...
  ## Attributes (return-only):
    ...
    - `:issuing_transaction_id` [binary]: transaction ID related to the IssuingCard.
    - `:errors` [list of binaries]: list of errors linked to this IssuingPurchase event
    - `:type` [binary]: type of the IssuingPurchase event which triggered the log creation. Options: "approved", "canceled", "confirmed", "denied", "reversed", "voided".
  ...
  @doc """
  Receive a stream of IssuingPurchase.Log objects previously created in the Stark Infra API
  ...
  ## Parameters (optional):
    ...
    - `:ids` [list of binaries, default nil]: list of IssuingPurchase ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
    - `:user` [Organization/Project, default nil]: Organization or Project object returned from StarkInfra.project(). Only necessary if default project or organization has not been set in configs.

  ## Return:
    - stream of IssuingPurchase.Log objects with updated attributes
  """
  @spec query(
    ids: [binary],
    limit: integer,
