defmodule StarkInfra.IssuingCard.Log do
    ...
    @doc """
    Receive a stream of IssuingCard.Log structs previously created in the Stark Infra API
    ...
    @doc """
    Receive a list of up to 100 IssuingCard.Log structs previously created in the Stark Infra API and the cursor to the next page.
