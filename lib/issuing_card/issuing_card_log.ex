defmodule StarkInfra.IssuingCard.Log do
  ...
  @moduledoc """
    Groups IssuingCard.Log related functions
  """
  ...
  ## Attributes (return-only):
    ...
    - `:type` [binary]: type of the IssuingCard event which triggered the log creation. ex: "blocked", "canceled", "created", "expired", "unblocked", "updated"
  ...
  ## Return:
    - IssuingCard.Log object that corresponds to the given id.
  """
  @spec get(
    id: binary,
  ...
  @doc """
  Receive a stream of IssuingCard.Log objects previously created in the Stark Infra API
  ...
  ## Parameters (optional):
    ...
    - `:types` [list of binaries, default nil]: filter for log event types. ex: ["blocked", "canceled", "created", "expired", "unblocked", "updated"]
    - `:card_ids` [list of binaries, default nil]: list of IssuingCard ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
