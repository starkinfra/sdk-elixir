defmodule StarkInfra.IssuingStock.Log do
  ...
  ## Attributes (return-only):
    ...
    - `:type` [IssuingStock]: type of the IssuingStock event which triggered the log creation. ex: "created", "spent", "restocked", "lost"
    - `:count` [binary]: shift in stock balance. ex: 10
  ...
  ## Return:
    - IssuingStock.Log object that corresponds to the given id.
  """
  @spec get(
    id: binary,
  ...
  @doc """
  Receive a stream of IssuingStock.Log objects previously created in the Stark Infra API
  ...
  ## Parameters (optional):
    ...
    - `:types` [list of binaries, default nil]: filter for log event types. ex: ["created", "spent", "restocked", "lost"]
    - `:stock_ids` [list of binaries, default nil]: list of IssuingStock ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
    - `:ids` [list of binaries, default nil]: list of IssuingStock ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
    - `:user` [Organization/Project, default nil]: Organization or Project object returned from StarkInfra.project(). Only necessary if default project or organization has not been set in configs.
