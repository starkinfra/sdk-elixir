defmodule StarkInfra.IssuingEmbossingRequest.Log do
  ...
  ## Attributes (return-only):
    ...
    - `:errors` [list of binaries]: list of errors linked to this IssuingEmbossingRequest event.
    - `:type` [binary]: type of the IssuingEmbossingRequest event which triggered the log creation. ex: "created", "sending", "sent", "processing", "success", "failed"
  ...
  ## Return:
    - IssuingEmbossingRequest.Log object that corresponds to the given id.
  """
  @spec get(
    id: binary,
  ...
  @doc """
  Receive a stream of IssuingEmbossingRequest.Log objects previously created in the Stark Infra API
  ...
  ## Parameters (optional):
    ...
    - `:types` [list of binaries, default nil]: filter for log event types. ex: ["created", "sending", "sent", "processing", "success", "failed"]
    - `:request_ids` [list of binaries, default nil]: list of IssuingEmbossingRequest ids to filter logs. ex: ["5656565656565656", "4545454545454545"]
