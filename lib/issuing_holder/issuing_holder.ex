defmodule StarkInfra.IssuingHolder do
  ...
  ## Parameters (required):
    ...
    - `:external_id` [binary]: card holder's external ID, generated by you. Must be unique per workspace to prevent duplicated holders. ex: "my-holder-id-1234"
  ...
  ## Parameters (required):
    - `:holders` [list of up to 100 IssuingHolder structs]: list of IssuingHolder structs to be created in the API in a single request.
  ...
  ## Parameters (optional):
    - `:status` [string, default nil]: new status for the holder. Options: "active", "blocked".
  ...
  @doc """
  Cancel an IssuingHolder entity previously created in the Stark Infra API. This action is
  irreversible.
