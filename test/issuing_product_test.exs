defmodule StarkInfraTest.IssuingProduct do
  ...
  test "page issuing product" do
    {:ok, {_cursor, issuing_products}} = StarkInfra.IssuingProduct.page(limit: 10)
    issuing_product = issuing_products |> Enum.take(1) |> hd
  ...
  @tag :issuing_product
  test "page! issuing product" do
    {nil, issuing_products} = StarkInfra.IssuingProduct.page!(limit: 10)
    issuing_product = issuing_products |> Enum.take(1) |> hd
